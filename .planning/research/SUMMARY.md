...
4. **Skill audit + prune (107 → ~60)** — remove duplicates of training-data knowledge. Evidence: HumanLayer (14-22% token savings), Multi-Instance Processing degradation. *Effort: 12-20h. Impact: High.*
