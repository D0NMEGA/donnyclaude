#!/usr/bin/env node
// donny-session-start.js: SessionStart hook. Emits structured additionalContext
...
async function main() {
  try {
    ...
    process.stderr.write('[donny-session-start] error: ' + (err && err.message ? err.message : String(err)) + '\n');
    process.exit(0);
  }
}
