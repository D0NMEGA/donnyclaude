...
Hook logic is implemented in Node.js scripts for cross-platform behavior on Windows, macOS, and Linux. A small number of shell wrappers are retained for continuous-learning-v2 observer hooks; those wrappers are profile-gated and have Windows-safe fallback behavior.
