#!/usr/bin/env node
// donny-hook-version: 1.33.0-ws3
// SessionStart Backup Restore Hook
//
// Pairs with donny-pre-compact-backup.js. Reads .claude/backups/, finds the
...
process.stdin.on('end', () => {
  ...
  try {
    ...
    process.stderr.write(`[donny-backup-restore] IO failure (fail-open): ${e.message}\n`);
    emitEmpty();
    process.exit(0);
  }
});
