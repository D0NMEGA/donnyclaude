...
Template for spawning donny-debugger agent. The agent contains all debugging expertise - this template provides problem context only.
...
```python
Task(prompt=template, subagent_type="donny-debugger", description="Debug UAT-001")
```
