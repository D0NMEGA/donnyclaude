...
- This section feeds directly into /donny-plan-phase --gaps
...
5. status -> "diagnosed"
6. Ready for /donny-plan-phase --gaps with root causes
...
**Creation:** When /donny-verify-work starts new session
...
- `/donny-verify-work {phase}` picks up from first pending/blocked test
