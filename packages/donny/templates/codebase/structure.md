...
│   └── donny/           # Donny-specific commands
├── donny/     # Skill resources
...
**New Slash Command:**
- Primary code: `commands/donny/{command-name}.md`
- Tests: `tests/commands/{command-name}.test.js` (if testing implemented)
- Documentation: Update `README.md` with new command

**New Template:**
- Implementation: `donny/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `donny/workflows/{name}.md`
- Usage: Reference from command with `@$HOME/.claude/donny/workflows/{name}.md`

**New Reference Document:**
- Implementation: `donny/references/{name}.md`
