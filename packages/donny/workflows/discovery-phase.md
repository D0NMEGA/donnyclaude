...
NOTE: For comprehensive ecosystem research ("how do experts build this"), use /donny-research-phase instead, which produces RESEARCH.md.
</purpose>
...
See $HOME/.claude/donny/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.claude/donny/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.claude/donny/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.claude/donny/templates/discovery.md
...
Use $HOME/.claude/donny/templates/discovery.md.
...
1. Discuss phase context (/donny-discuss-phase [current-phase])
2. Create phase plan (/donny-plan-phase [current-phase])
