...
<trigger>
This workflow executes when `--power` flag is present in ARGUMENTS to `/donny:discuss-phase`.
...
Consider running /donny:discuss-phase {N} again to refine before planning.
```
