# Donny Artifact Types

This reference documents all artifact types in the Donny planning taxonomy. Each type has a defined
...
- **Location**: `$HOME/.claude/donny/USER-PROFILE.md`
