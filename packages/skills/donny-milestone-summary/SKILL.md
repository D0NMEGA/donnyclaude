---
name: donny-milestone-summary
description: "Generate a human-readable milestone summary from the planning artifacts (ROADMAP, REQUIREMENTS, per-phase CONTEXT/SUMMARY/VERIFICATION) covering architecture, phases, key decisions, requirements, and tech debt. Use when someone needs to understand a finished or in-progress milestone from one document, for team onboarding or review."
...
<execution_context>
@~/.claude/donny/workflows/milestone-summary.md
</execution_context>
...
<process>
Read and execute the milestone-summary workflow from @~/.claude/donny/workflows/milestone-summary.md end-to-end.
</process>
