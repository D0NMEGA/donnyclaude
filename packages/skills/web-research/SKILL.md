...
```bash
python3 ~/Developer/scrapers/research_topic.py "llm agents" --limit 12
...
```bash
python3 ~/Developer/scrapers/research.py hn            --query "AI agents" --days 30 --limit 30 --comments 5
python3 ~/Developer/scrapers/research.py github        --query "topic:llm stars:>200" --limit 30
python3 ~/Developer/scrapers/research.py github_trending --query weekly --limit 30   # daily|weekly|monthly
python3 ~/Developer/scrapers/research.py devto         --tag ai --days 30 --limit 30
python3 ~/Developer/scrapers/research.py arxiv         --category cs.AI --limit 30
python3 ~/Developer/scrapers/research.py openalex      --query "retrieval augmented generation" --limit 30
python3 ~/Developer/scrapers/research.py huggingface   --query bert --limit 30
python3 ~/Developer/scrapers/research.py npm           --query "llm agent" --limit 30
python3 ~/Developer/scrapers/research.py stackoverflow --tag langchain --limit 30 --answers 3
python3 ~/Developer/scrapers/research.py lobsters      --limit 30
python3 ~/Developer/scrapers/research.py medium        --tag machine-learning --limit 20
```
